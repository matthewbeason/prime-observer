...
class TransformLatestTest(unittest.TestCase):
    ...
    def test_browser_files_render_phase_4_dashboard_hierarchy(self):
        ...
        self.assertIn("Network condition", dashboard_html)
        self.assertIn("User-facing impact", dashboard_html)
        self.assertIn("What is affected", dashboard_html)
        self.assertIn("Likely issue", dashboard_html)
        self.assertIn("DNS resolver path details", dashboard_html)
