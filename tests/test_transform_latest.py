...
class TransformLatestTest(unittest.TestCase):
    ...
    def test_browser_files_render_phase_4_dashboard_hierarchy(self):
        ...
        self.assertIn("Operator Assessment", dashboard_html)
        self.assertNotIn("Deterministic Operator Summary", dashboard_html)
        self.assertNotIn("id=\"operatorSummarySource\"", dashboard_html)
        self.assertIn("Gateway Path", dashboard_html)
        self.assertNotIn(">Connection<", dashboard_html)
        self.assertIn("Technical Condition", dashboard_html)
        self.assertIn("Estimated User Impact", dashboard_html)
        self.assertIn("Affected Scope", dashboard_html)
        self.assertIn("Current Action", dashboard_html)
        self.assertIn("DNS Resolver Paths", dashboard_html)
        self.assertIn("DNS Activity", dashboard_html)
        self.assertIn("Refined Attribution", dashboard_html)
        ...
        self.assertIn("mobileTechnicalConditionValue", dashboard_html)
        self.assertIn("mobileUserImpactValue", dashboard_html)
        self.assertIn("mobileAffectedScopeValue", dashboard_html)
        self.assertIn("mobileCurrentActionValue", dashboard_html)
        ...
        self.assertIn("Current Status And Impact", investigation_html)
        self.assertIn("Affected And Healthy Scope", investigation_html)
        self.assertIn("Evidence Quality", investigation_html)
