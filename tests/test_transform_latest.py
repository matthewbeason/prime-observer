...
class TransformLatestTest(unittest.TestCase):
    ...
    def test_browser_files_render_phase_4_dashboard_hierarchy(self):
        ...
        self.assertIn("Likely Cause", dashboard_html)
        self.assertIn("Resolver Evidence", dashboard_html)
        self.assertIn("DNS Activity", dashboard_html)
        self.assertIn("Attribution Evidence", dashboard_html)
        ...
        self.assertIn("Estimated / Observed Impact", investigation_html)
