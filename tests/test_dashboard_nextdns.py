...
class DashboardNextDnsTest(unittest.TestCase):
    ...
    def test_dashboard_explains_heatmap_and_chart_semantics(self):
        ...
        self.assertIn('renderHeatmap("#heatmap", currentVizState.compositeWanBuckets, currentVizState.semanticAvailable)', html)
        self.assertNotIn("function buildCompositeWanBuckets", html)
        self.assertNotIn("function getNoticeabilitySummary", html)
        self.assertIn("Internet degraded", html)
        self.assertIn("Resolver degraded", html)
        self.assertIn("dark gray = sustained Python-classified degradation after learned comparison and guardrails", html)
        self.assertIn("line = p95 latency only", html)
        self.assertIn("Absolute threshold reasons: p95", html)
        self.assertIn("operator-bad", html)
    ...
    def test_dashboard_ux_copy_uses_clearer_local_loading_and_selection_states(self):
        ...
        self.assertIn("Open current incident", html)
        ...
        self.assertIn("Latest measurement", html)
        self.assertNotIn("function connectionStatusForP95", html)
        ...
        self.assertIn("Open current incident", html)
        self.assertIn("Open selected interval evidence", html)
        self.assertIn("Historical interval — not current", html)
        self.assertIn('url.searchParams.set("view", bucket ? "interval" : "current")', html)
        self.assertIn('href="./investigate.html?view=current"', html)
        ...
        self.assertIn('setAttribute("aria-label", bucket ? "Open selected interval evidence" : "Open current incident")', html)
    ...
    def test_dashboard_trust_repair_hides_internal_or_empty_primary_text(self):
        ...
        self.assertIn("Network is working normally now. Instability was detected earlier.", html)
        self.assertIn("Network is currently ${healthLabel(technicalState).toLowerCase()} based on current probe evidence.", html)
